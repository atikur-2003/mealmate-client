...
const Footer = () => {
  return (
    // <footer className="footer sm:footer-horizontal footer-center bg-slate-800 text-primary-content p-10">
    //   <aside>
    //    <img className="w-20 rounded-full bg-white" src={logo} alt="" />
